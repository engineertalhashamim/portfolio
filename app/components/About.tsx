...
const About = () => {
  ...
  return (
    <motion.div
      ...
      id="about"
      className="w-full px-[12%] pt-5 sm:pt-0 scroll-mt-20"
    >
      <motion.h4
      ...
      <motion.h2
        ...
        className="text-center mb-2 text-4xl sm:text-5xl font-ovo"
      >
        About Me
      </motion.h2>
      ...
      <motion.div
        ...
        className="flex w-full flex-col lg:flex-row items-center gap-10 sm:gap-20 mt-10 mb-10 sm:mb-20"
      >
        <motion.div
        ...
        >
          <p className="mb-10 max-w-2xl font-ovo">
            ...
            delivering efficient solutions across modern frameworks and CMS
            platforms.
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
